package cn.lry.dncwave.ui.view;
...
import cn.lry.dncwave.R;
import cn.lry.dncwave.utils.Util;
...
public class PorterDuffXfermodeView extends View {
    ...
    public PorterDuffXfermodeView(Context context, AttributeSet attrs) {
        ...
        mSpeed = Util.dipToPx(context, WAVE_TRANS_SPEED);
    ...
    private void initBitmap() {
        mSrcBitmap = ((BitmapDrawable) getResources().getDrawable(R.mipmap.wave_2000)).getBitmap();
        mMaskBitmap = ((BitmapDrawable) getResources().getDrawable(R.mipmap.circle_500)).getBitmap();
    }
